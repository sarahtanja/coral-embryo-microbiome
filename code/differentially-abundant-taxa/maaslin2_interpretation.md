...
> **Note:** This document provides historical documentation for MaAsLin2 analysis. For current analysis using MaAsLin3, which improves on MaAsLin2 by better accounting for compositionality, see [maaslin3.qmd](maaslin3.qmd). The concepts and interpretation principles described here remain relevant for understanding statistical modeling in differential abundance analysis.
...
This document explains the MaAsLin2 model design used historically in the coral embryo microbiome analysis. The principles described here apply to both MaAsLin2 and MaAsLin3, though MaAsLin3 provides improved handling of compositional data.

For current MaAsLin3 implementation with multiple model specifications, see [maaslin3.qmd](maaslin3.qmd).
...
For more on MaAsLin2 and MaAsLin3 model interpretation:
...
- Current MaAsLin3 implementation: [maaslin3.qmd](maaslin3.qmd)
