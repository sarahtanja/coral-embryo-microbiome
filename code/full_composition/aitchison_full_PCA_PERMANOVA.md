Aitchison Distance PCA & PERMANOVA on the complete Feature Table
================
Sarah Tanja
10/17/25

<link href="aitchison_full_PCA_PERMANOVA_files/libs/htmltools-fill-0.5.8.1/fill.css" rel="stylesheet" />
<script src="aitchison_full_PCA_PERMANOVA_files/libs/htmlwidgets-1.6.4/htmlwidgets.js"></script>
<script src="aitchison_full_PCA_PERMANOVA_files/libs/plotly-binding-4.11.0/plotly.js"></script>
<script src="aitchison_full_PCA_PERMANOVA_files/libs/setprototypeof-0.1/setprototypeof.js"></script>
<script src="aitchison_full_PCA_PERMANOVA_files/libs/typedarray-0.1/typedarray.min.js"></script>
<script src="aitchison_full_PCA_PERMANOVA_files/libs/jquery-3.5.1/jquery.min.js"></script>
<link href="aitchison_full_PCA_PERMANOVA_files/libs/crosstalk-1.2.2/css/crosstalk.min.css" rel="stylesheet" />
<script src="aitchison_full_PCA_PERMANOVA_files/libs/crosstalk-1.2.2/js/crosstalk.min.js"></script>
<link href="aitchison_full_PCA_PERMANOVA_files/libs/plotly-htmlwidgets-css-2.11.1/plotly-htmlwidgets.css" rel="stylesheet" />
<script src="aitchison_full_PCA_PERMANOVA_files/libs/plotly-main-2.11.1/plotly-latest.min.js"></script>
...
- <a href="#setup" id="toc-setup"><span
  ...
  - <a href="#install-load-packages" id="toc-install-load-packages"><span
    class="toc-section-number">2.1</span> Install &amp; load packages</a>
- <a href="#load-data" id="toc-load-data"><span
  class="toc-section-number">3</span> Load Data</a>
  - <a href="#load-metadata" id="toc-load-metadata"><span
    class="toc-section-number">3.1</span> Load metadata</a>
  - <a href="#import-qiime2-artifacts"
    id="toc-import-qiime2-artifacts"><span
    class="toc-section-number">3.2</span> Import QIIME2 artifacts</a>
    - <a href="#feature-table" id="toc-feature-table"><span
      class="toc-section-number">3.2.1</span> Feature table</a>
    - <a href="#taxonomy" id="toc-taxonomy"><span
      class="toc-section-number">3.2.2</span> Taxonomy</a>
  - <a href="#prepare-data-for-analysis"
    id="toc-prepare-data-for-analysis"><span
    class="toc-section-number">3.3</span> Prepare data for analysis</a>
- <a href="#clr-transformation" id="toc-clr-transformation"><span
  class="toc-section-number">4</span> CLR Transformation</a>
- <a href="#aitchison-distance" id="toc-aitchison-distance"><span
  class="toc-section-number">5</span> Aitchison Distance</a>
- <a href="#pca-biplots" id="toc-pca-biplots"><span
  class="toc-section-number">6</span> PCA Biplots</a>
  - <a href="#plot-stage-x-leachate-x-cross"
    id="toc-plot-stage-x-leachate-x-cross"><span
    class="toc-section-number">6.1</span> Plot stage x leachate x cross</a>
  - <a href="#plot-stage-x-leachate-x-spawn-night"
    id="toc-plot-stage-x-leachate-x-spawn-night"><span
    class="toc-section-number">6.2</span> Plot stage x leachate x spawn
    night</a>
  - <a href="#interactive-plotly" id="toc-interactive-plotly"><span
    class="toc-section-number">6.3</span> Interactive plotly</a>
- <a href="#permanova" id="toc-permanova"><span
  class="toc-section-number">7</span> PERMANOVA</a>
  - <a href="#fit-betadispr" id="toc-fit-betadispr"><span
    class="toc-section-number">7.1</span> Fit betadispr</a>
    - <a href="#night" id="toc-night"><span
      class="toc-section-number">7.1.1</span> night</a>
    - <a href="#leachate" id="toc-leachate"><span
      class="toc-section-number">7.1.2</span> leachate</a>
    - <a href="#stage" id="toc-stage"><span
      class="toc-section-number">7.1.3</span> stage</a>
    - <a href="#leachate-x-stage" id="toc-leachate-x-stage"><span
      class="toc-section-number">7.1.4</span> leachate x stage</a>
  - <a href="#perform-permanova" id="toc-perform-permanova"><span
    class="toc-section-number">7.2</span> Perform PERMANOVA</a>
- <a href="#summary" id="toc-summary"><span
  class="toc-section-number">8</span> Summary</a>
  - <a href="#key-findings" id="toc-key-findings"><span
    class="toc-section-number">8.1</span> Key Findings</a>
  - <a href="#next-steps" id="toc-next-steps"><span
    class="toc-section-number">8.2</span> Next Steps</a>
  - <a href="#output-files" id="toc-output-files"><span
    class="toc-section-number">8.3</span> Output Files</a>
- <a href="#session-info" id="toc-session-info"><span
  class="toc-section-number">9</span> Session Info</a>
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-12-1.png)
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-17-1.png)
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-19-1.png)
...
```
    ...
    Response: Distances
              Df  Sum Sq Mean Sq      F N.Perm Pr(>F)
    Groups     2   99.76  49.879 1.0498    999  0.343
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-21-1.png)
...
```
    ...
    Response: Distances
              Df  Sum Sq Mean Sq      F N.Perm Pr(>F)
    Groups    11  212.66  19.333 0.3491    999  0.966
...
![](aitchison_full_PCA_PERMANOVA_files/figure-commonmark/unnamed-chunk-23-1.png)
...
```
    ...
    other attached packages:
     [1] plotly_4.11.0         corrplot_0.95         reshape2_1.4.4       
    ...
    [13] XVector_0.48.0          labeling_0.4.3          rmarkdown_2.30         
    [16] tzdb_0.5.0              UCSC.utils_1.4.0        ragg_1.5.0             
    [19] bit_4.6.0               xfun_0.53               GenomeInfoDb_1.44.3    
    ...
    [31] rpart_4.1.24            Rcpp_1.1.0              iterators_1.0.14       
    [34] knitr_1.50              base64enc_0.1-3         IRanges_2.42.0         
    ...
    [49] Biobase_2.68.0          withr_3.0.2             S7_0.2.0               
    [52] evaluate_1.0.5          foreign_0.8-90          bayesm_3.1-6           
    [55] Biostrings_2.76.0       pillar_1.11.1           tensorA_0.36.2.1       
    [58] checkmate_2.3.3         DT_0.34.0               foreach_1.5.2          
    [61] stats4_4.5.1            generics_0.1.4          vroom_1.6.6            
    [64] S4Vectors_0.46.0        hms_1.1.3               scales_1.4.0           
    [67] glue_1.8.0              Hmisc_5.2-4             lazyeval_0.2.2         
    [70] tools_4.5.1             robustbase_0.99-6       data.table_1.17.8      
    [73] rhdf5_2.52.1            grid_4.5.1              ape_5.8-1              
    [76] crosstalk_1.2.2         colorspace_2.1-2        nlme_3.1-168           
    [79] GenomeInfoDbData_1.2.14 htmlTable_2.4.3         Formula_1.2-5          
    [82] cli_3.6.5               textshaping_1.0.3       viridisLite_0.4.2      
    [85] gtable_0.3.6            DEoptimR_1.1-4          digest_0.6.37          
    [88] BiocGenerics_0.54.1     htmlwidgets_1.6.4       farver_2.1.2           
    [91] htmltools_0.5.8.1       multtest_2.64.0         lifecycle_1.0.4        
