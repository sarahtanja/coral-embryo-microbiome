...
```{r}
path <- read_qza("../../output/picrust2_epa-ng/pathway_abundance.qza")$data
```

```{r}
ko <- read_qza("../../output/picrust2_epa-ng/ko_metagenome.qza")$data
```
...
output_path <- "../../output/picrust2_epa-ng/"
