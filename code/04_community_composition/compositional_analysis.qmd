...
```{r custom-pca}
# color palette
night.colors.alt <- c("July 6th" = "#21918C", 
                      "July 7th" = "#578B21", 
                      "July 8th" = "#1E2440")
...
```{r betadispr-combo-plot, fig.width=5, fig.height=9}
bd_plots <- (bd_night_plot / bd_leachate_plot / bd_stage_plot) +
  plot_annotation(tag_levels = "A", 
                  title = "Principle Coordinates Analysis (PCoA) \nof Within-Group Beta Diversity Dispersion") &
  theme(
