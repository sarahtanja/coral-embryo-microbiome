...
```{r, engine='bash'}
qiime tools view ../output/imported_reads_trimmed.qzv

```

Use QIIME 2 View to view the `.qzv` or `.qza` file:

1.  Copy the `.qzv` or `.qza` file to your local machine:

    `scp user@remote:/path/to/file.qzv .`
...
qiime dada2 denoise-paired 
  --i-demultiplexed-seqs ../250414_StonyCoral_imported_reads_trimmed.qza 
  --p-n-threads 20 
  --p-trunc-len-f 270 
  --p-trunc-len-r 200 
  --verbose 
  --o-table 250414_StonyCoral_270x200_featureTable.qza 
  --o-representative-sequences 250414_StonyCoral_240x230_representative-sequences.qza 
  --o-denoising-stats 250414_StonyCoral_240x230_denoising-stats.qza
```
