...
subtitle: "Choosing a model formula using Maaslin3"
author: "Sarah Tanja"
date: 2025-05-12
date-modified: today
format:
...
Here we aim to test changes in abundance (how many, relative) and prevalence
...
and introduced nuisance variation into our microbiome data. To account for this
...
## 1v1.2 cat x con (don't include random intercept for spawn night)
```{r eval=FALSE, warning=FALSE, message=FALSE}
set.seed(1)
fit_Level7_Model1v1.2 <- maaslin3(
  input_data = ft_l7,
  input_metadata = meta,
  output = file.path(output_path, "Interaction/interaction_nospawn"),
  formula = ~ leachate * hpf + reads,
  normalization = 'TSS',
  transform = 'LOG',
  correction = 'BH',
  verbosity = 'ERROR',
