...
ggsave("../output/figures/taxa_barplot_level1_kingdom.png", 
       plot = p_level1, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level2_phylum.png", 
       plot = p_level2, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level3_class.png", 
       plot = p_level3, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level4_order.png", 
       plot = p_level4, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level5_family.png", 
       plot = p_level5, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level6_genus.png", 
       plot = p_level6, width = 12, height = 8, dpi = 300)

ggsave("../output/figures/taxa_barplot_level7_species.png", 
