...
> If you’re on Windows RStudio (Desktop) but Miniconda is on Linux/WSL... Your bash chunks might be using Windows Git-Bash, not the Linux bash that has ~/miniconda3. Point knitr to the Linux bash first.
